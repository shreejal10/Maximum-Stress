...
/*
 * Serialization is a process of writing object to a file. for this ObjectOutputStream is used.
 * Process of reading object from file is deserialization. fot his ObjectInputStream is used.
 * Steps:
 * 1. Create a file and open it in write mode using byte stream
 * 2. Create object of ObjectOutputStream and pass object of fileOutputStream as a parameter and call writeObject() method
 * 3. close the stream
